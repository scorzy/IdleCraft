...
export const addHealth = (state: GameState, charId: string | CharacterState, amount: number): void => {
    ...
    char.health = Math.max(0, Math.min(char.health + amount, maxHealth))
}
