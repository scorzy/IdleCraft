...
export const ExpData: Record<ExpEnum, { nameId: keyof Msg }> = {
    ...
    [ExpEnum.LightArmour]: { nameId: 'LightArmour' },
    [ExpEnum.MediumArmour]: { nameId: 'MediumArmour' },
    [ExpEnum.HeavyArmour]: { nameId: 'HeavyArmour' },
    [ExpEnum.Butchering]: { nameId: 'ButcheringExp' },
    [ExpEnum.Alchemy]: { nameId: 'Alchemy' },
    [ExpEnum.Gathering]: { nameId: 'Gathering' },
    [ExpEnum.Persuasion]: { nameId: 'PersuasionExp' },
}
