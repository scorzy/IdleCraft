...
describe('Exp Functions', () => {
    ...
    test('addExp level 0', () => {
        const state = GetInitialGameState()
        addExp(state, ExpEnum.Mining, 100)
        const char = CharacterAdapter.selectEx(state.characters, PLAYER_ID)
    ...
    test('addExp level 2', () => {
        const state = GetInitialGameState()
        addExp(state, ExpEnum.Mining, 1000)
        addExp(state, ExpEnum.Mining, 1200)
        const char = CharacterAdapter.selectEx(state.characters, PLAYER_ID)
    ...
    test('addExp char level 1', () => {
        const state = GetInitialGameState()
        addExp(state, ExpEnum.Mining, 5000)
        addExp(state, ExpEnum.Archery, 5000)
        const char = CharacterAdapter.selectEx(state.characters, PLAYER_ID)
    ...
    test('addExp char level 0', () => {
        const state = GetInitialGameState()
        addExp(state, ExpEnum.Mining, 4999)
        addExp(state, ExpEnum.Archery, 5000)
        const char = CharacterAdapter.selectEx(state.characters, PLAYER_ID)
