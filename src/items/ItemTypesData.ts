...
export const ItemTypesData: Record<ItemTypes, { nameId: keyof Msg; icon: Icons }> = {
    ...
    [ItemTypes.Head]: { nameId: 'Head', icon: Icons.Helmet },
    [ItemTypes.Body]: { nameId: 'Body', icon: Icons.Breastplate },
    [ItemTypes.Legs]: { nameId: 'Legs', icon: Icons.Cuisses },
    [ItemTypes.Hands]: { nameId: 'Hands', icon: Icons.Gauntlet },
    [ItemTypes.Feet]: { nameId: 'Feet', icon: Icons.Boots },
