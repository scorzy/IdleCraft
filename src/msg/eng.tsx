...
export const engMsg: Msg = {
    ...
    CedarLog: 'Cedar Log',
    RedwoodLog: 'Redwood Log',
    SpruceLog: 'Spruce Log',
    MahoganyLog: 'Mahogany Log',
    DeadTreePlank: 'Dead Tree Plank',
    OakPlank: 'Oak Plank',
    PinePlank: 'Pine Plank',
    BirchPlank: 'Birch Plank',
    MaplePlank: 'Maple Plank',
    WillowPlank: 'Willow Plank',
    CedarPlank: 'Cedar Plank',
    RedwoodPlank: 'Redwood Plank',
    SprucePlank: 'Spruce Plank',
    MahoganyPlank: 'Mahogany Plank',
    DeadTreeHandle: 'Dead Tree Handle',
    OakHandle: 'Oak Handle',
    PineHandle: 'Pine Handle',
    BirchHandle: 'Birch Handle',
    MapleHandle: 'Maple Handle',
    WillowHandle: 'Willow Handle',
    CedarHandle: 'Cedar Handle',
    RedwoodHandle: 'Redwood Handle',
    SpruceHandle: 'Spruce Handle',
    MahoganyHandle: 'Mahogany Handle',
    ...
    WillowForest: 'Willow Forest',
    CedarForest: 'Cedar Forest',
    RedwoodForest: 'Redwood Forest',
    SpruceForest: 'Spruce Forest',
    MahoganyForest: 'Mahogany Forest',
    Cutting: 'Cutting',
    TreeHP: 'Tree HP',
    Cut: 'Cut',
    Trees: 'Trees',
